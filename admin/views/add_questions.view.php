...
<div class="container">
        ...
        <h3 class="display-4 text-center mb-5">Add questions to <?php echo $test_category['name'] ?></h3><hr>
        ...
        <div class="col-9">
                    <form  action="admin/add_questions.php?id=<?php echo $test_id?>" method="POST" autocomplete="off"  class="d-flex justify-content-start">
                            ...
                            <?php foreach ($questions as $index => $questionByCategory):?>
                                <option value="<?php echo $questionByCategory['id']?>"><?php echo $questionByCategory['question']; ?> </option>
                            <?php endforeach; ?>
                            </select>
                            <button id="btnSubmit" name="chooseQuestion" type="submit" class="btn btn-sm btn-primary">Add to list</button>
                    </form>  
...
<div class="row">
        <div class="col-12 mt-5">
                ...
                <tr>
                    <th scope="row"><?php echo $i+1; ?></th>
                        ...
                        <td style="text-align:right">
                            <a href="admin/edit_question.php?id=<?php echo $test_questions[$i]['id']?>&test_id=<?php echo $test_id?>" class="btn btn-warning btn-sm"><i class="far fa-edit"></i></i></a>
                        </td>
                        <td style="text-align:right">
                        <a href="admin/delete_question_for_test.php?id=<?php echo $test_questions[$i]['tq_id']?>" class="btn btn-danger btn-sm"><i class="fas fa-backspace"></i></a>
                        </td>
                </tr>
            <?php endfor; ?>
            ...
            <form id="formAddQuestion" action="admin/add_questions.php?id=<?php echo $test_id?>" enctype="multipart/form-data" method="POST" class="d-none">
                <textarea name="body" class="form-control" cols="30" rows="10" placeholder="Enter question" required></textarea>             
            ...
            <h5 class="mt-5">Or Options</h5><hr>
                ...
                <hr>
                <div class="mt-3">
                    <input id="poensInput" type="text" name="poens" class="form-control" style="width:50%" placeholder="Enter maximum poens..." required>
