    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="edit_department_sections.php?id=<?php echo $department->id?>"
                        class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a></td>
                <td><a href="show_department.php?id=<?php echo $department->id?>" class="btn btn-primary btn-sm"><i
